...
public class StudentTest {
	...
	public static void main(String[] args) {
		...
		System.out.println(studentOne.getName()+ " "+ studentOne.getSubname()+", grade media: "+studentOne.gradeMedia());
		System.out.println(studentTwo.getName()+ " "+ studentTwo.getSubname()+", grade media: "+studentTwo.gradeMedia());
		System.out.println(studentThree.getName()+ " "+ studentThree.getSubname()+", grade media: "+studentThree.gradeMedia());
